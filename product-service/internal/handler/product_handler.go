...
func (h *ProductHandler) CreateProduct(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		WriteError(w, http.StatusBadRequest, "INVALID_REQUEST_BODY", "Request body is invalid")
		return
	}
	...
	if err != nil {
		WriteError(w, http.StatusBadRequest, "PRODUCT_CREATION_FAILED", err.Error())
		return
	}
...
func (h *ProductHandler) GetProduct(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		if errors.Is(err, repository.ErrProductNotFound) {
			WriteError(w, http.StatusNotFound, "PRODUCT_NOT_FOUND", "Product was not found")
			return
		}

		WriteError(w, http.StatusInternalServerError, "INTERNAL_SERVER_ERROR", "An internal server error occurred")
		return
	}

...
func (s *ProductService) CreateProduct(
	...
	if s.producer != nil {
		_ = s.producer.Publish(ctx, "product.created", product)
	}
...
func (s *ProductService) UpdateProduct(
	...
	if s.producer != nil {
		_ = s.producer.Publish(ctx, "product.updated", product)
	}
...
func (s *ProductService) DeleteProduct(
	...
	if s.producer != nil {
		_ = s.producer.Publish(ctx, "product.deleted", map[string]string{
			"id": id.String(),
		})
	}
